			...
			<tr>
				...
				<th>
					<div  class="d-flex justify-content-between">
						...
						<div>
							<button type="button" class="btn btn-success" onclick="location.href='/2/qna/saveForm'">글쓰기</button>
						</div>
					</div>
				</th>
			</tr>
...
<ul class="pagination order-2">
      ...
      <c:choose>
         ...
         <c:otherwise>
            <li class="page-item"><a class="page-link" href="/${animalId}/qna?page=${qna.number-1}"><</a></li>
         </c:otherwise>
      </c:choose>
