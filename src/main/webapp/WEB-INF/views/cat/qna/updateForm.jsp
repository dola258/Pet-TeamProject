	...
	<form onsubmit="update(event, ${qnaEntity.id})" >
		<div class="mt-4 p-5 bg-light text-white rounded">
			...
			<div class="d-flex justify-content-end">
				...
				<button type="button" class="btn btn-secondary btn-cancel" onclick="location.href='http://localhost:8080/1/qna?page=0'">취소</button>
			</div>
		</div>
	</form>
</div>
...
async function update(event, id){ 
	   ...
	   let boastUpdateDto = {
		...
		let response = await fetch("http://localhost:8080/api/1/qna/"+id, {
			method: "put",
