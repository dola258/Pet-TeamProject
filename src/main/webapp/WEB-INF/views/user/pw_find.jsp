...
<div class="container">
	...
	<form onsubmit="findPassword(event)">
		<div class="mb-3 mt-3">
			<label for="name">아이디:</label> <input type="text" class="form-control" id="id" placeholder="아이디를 입력해주세요." required="required">
		</div>
		<div class="mb-3 mt-3">
			<label for="name">이름:</label> <input type="text" class="form-control" id="name" placeholder="이름을 입력해주세요." required="required">
		</div>
		<div class="mb-3 mt-3">
			<label for="birthday">생년월일:</label><br /> <input type="date" name="dateofbirth" required="required">
		</div>
		<div class="mb-3">
			<label for="email">이메일:</label> <input type="email" class="form-control" id="email" placeholder="등록된 이메일을 입력해주세요" required="required">
		</div>
